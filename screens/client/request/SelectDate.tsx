...
const SelectDate: React.FC = () => {
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col bg-[#121212] group/design-root overflow-x-hidden text-white">
      ...
      <p className="px-4 text-[#A0A0A0] text-sm">Julho 2024</p>
      ...
      <div className="p-4 pt-2 border-t border-[#333333] sticky bottom-0 bg-[#121212]">
        <button 
            ...
            className={`w-full h-14 rounded-xl font-bold text-base flex items-center justify-center transition-colors ${selectedDate && selectedTime ? 'bg-[#800020] text-white shadow-lg shadow-[#800020]/20 hover:bg-[#800020]/90' : 'bg-[#333333] text-[#A0A0A0] cursor-not-allowed'}`}
        >
            Revisar Agendamento
        </button>
      </div>
