    ...
    return (
        <div className="relative flex h-auto min-h-screen w-full flex-col bg-[#121212] group/design-root overflow-x-hidden text-white font-display">
            ...
            <div className="flex items-center p-4 pb-2 justify-between sticky top-0 bg-[#121212] z-50">
                ...
                <h1 className="text-lg font-bold leading-tight flex-1 text-center">Endereço de Coleta</h1>
            ...
            <div className="flex w-full flex-row items-center justify-center gap-3 py-5 px-4">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p className="text-[#555555] text-xs font-bold">Entrega</p>
                </div>
                <div className="w-6 h-px bg-[#333333]"></div>
                <div className="flex flex-col items-center gap-2">
                    <div className="h-2.5 w-2.5 rounded-full bg-[#333333]"></div>
            ...
            <main className="flex-1 p-4 pb-24 flex flex-col gap-4">
                ...
                <div
                    ...
                    className={`bg-[#1E1E1E] rounded-xl p-4 border-2 cursor-pointer transition-all ${useProfileAddress ? 'border-[#d41142] bg-[#d41142]/5' : 'border-[#333333] hover:border-[#d41142]/30'
                        }`}
                >
                    <div className="flex items-center gap-3">
                        <div className={`h-5 w-5 rounded border-2 flex items-center justify-center transition-all ${useProfileAddress ? 'border-[#d41142] bg-[#d41142]' : 'border-[#555555]'
                            }`}>
                            {useProfileAddress && (
                        ...
                        <div className="flex-1">
                            <h3 className="text-white font-bold text-sm">Usar endereço do perfil</h3>
                            <p className="text-[#A0A0A0] text-xs mt-0.5">Rua das Flores, 123 - Centro</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="p-4 pt-2 border-t border-[#333333] sticky bottom-0 bg-[#121212]">
                <button
                    onClick={() => navigate('/pickup/delivery-address')}
                    disabled={!useProfileAddress && !isFormValid()}
                    className={`w-full h-14 rounded-xl font-bold text-base flex items-center justify-center transition-colors ${useProfileAddress || isFormValid()
